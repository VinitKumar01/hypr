...
hl.bind(mainMod .. " + BACKSPACE", hl.dsp.exec_cmd(scrPath .. "/logoutlaunch.sh"), { description = "launch logout menu" })
hl.bind("CTRL + ALT + W", hl.dsp.exec_cmd("killall waybar || (env reload_flag=1 " .. scrPath .. "/wbarconfgen.sh)"), { description = "toggle waybar" })
...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(editor), { description = "launch text editor" })
...
hl.bind("CTRL + SHIFT + ESCAPE", hl.dsp.exec_cmd(scrPath .. "/sysmonlaunch.sh"), { description = "launch system monitor" })

-- Rofi menus
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/rofilaunch.sh d"), { description = "launch app launcher" })
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/rofilaunch.sh w"), { description = "launch window switcher" })
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/rofilaunch.sh f"), { description = "launch file explorer" })

-- Audio control
hl.bind("F10", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -o m"), { lock = true, description = "toggle audio mute" })
hl.bind("F11", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -o d"), { repeat_press = true, lock = true, description = "decrease volume" })
hl.bind("F12", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -o i"), { repeat_press = true, lock = true, description = "increase volume" })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -o m"), { lock = true, description = "toggle audio mute" })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -i m"), { lock = true, description = "toggle mic mute" })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -o d"), { repeat_press = true, lock = true, description = "decrease volume" })
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(scrPath .. "/volumecontrol.sh -o i"), { repeat_press = true, lock = true, description = "increase volume" })
...
-- Brightness control
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd(scrPath .. "/brightnesscontrol.sh i"), { repeat_press = true, lock = true, description = "increase brightness" })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(scrPath .. "/brightnesscontrol.sh d"), { repeat_press = true, lock = true, description = "decrease brightness" })
...
hl.bind(mainMod .. " + CTRL + P", hl.dsp.exec_cmd(scrPath .. "/screenshot.sh sf"), { description = "partial screenshot (frozen)" })
...
hl.bind(mainMod .. " + ALT + RIGHT", hl.dsp.exec_cmd(scrPath .. "/swwwallpaper.sh -n"), { description = "next wallpaper" })
hl.bind(mainMod .. " + ALT + LEFT", hl.dsp.exec_cmd(scrPath .. "/swwwallpaper.sh -p"), { description = "previous wallpaper" })
hl.bind(mainMod .. " + ALT + UP", hl.dsp.exec_cmd(scrPath .. "/wbarconfgen.sh n"), { description = "next waybar mode" })
hl.bind(mainMod .. " + ALT + DOWN", hl.dsp.exec_cmd(scrPath .. "/wbarconfgen.sh p"), { description = "previous waybar mode" })
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/wallbashtoggle.sh -m"), { description = "wallbash mode menu" })
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/themeselect.sh"), { description = "theme select menu" })
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/rofiselect.sh"), { description = "rofi select menu" })
hl.bind(mainMod .. " + SHIFT + X", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/themestyle.sh"), { description = "theme style menu" })
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/swwwallselect.sh"), { description = "wallpaper select menu" })
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/cliphist.sh c"), { description = "launch clipboard" })
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/cliphist.sh"), { description = "launch clipboard manager" })
hl.bind(mainMod .. " + K", hl.dsp.exec_cmd(scrPath .. "/keyboardswitch.sh"), { description = "switch keyboard layout" })
hl.bind(mainMod .. " + SLASH", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/keybinds_hint.sh c"), { description = "launch keybinds hint" })
hl.bind(mainMod .. " + ALT + A", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/animations.sh"), { description = "launch animations manager" })
...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + SHIFT + " .. key, hl.dsp.window.move({ workspace = tostring(i) }), { description = "Move to Workspace " .. i })

    -- Move window to workspace silent: SUPER + ALT + [1-0]
    hl.bind(mainMod .. " + ALT + " .. key, hl.dsp.window.move({ workspace = tostring(i), follow = false }), { description = "Move to Workspace " .. i .. " (Silent)" })
end
...
hl.bind(mainMod .. " + SHIFT + CTRL + RIGHT", hl.dsp.window.resize({ x = 30, y = 0, relative = true }), { repeat_press = true, description = "resize right" })
hl.bind(mainMod .. " + SHIFT + CTRL + LEFT", hl.dsp.window.resize({ x = -30, y = 0, relative = true }), { repeat_press = true, description = "resize left" })
hl.bind(mainMod .. " + SHIFT + CTRL + UP", hl.dsp.window.resize({ x = 0, y = -30, relative = true }), { repeat_press = true, description = "resize up" })
hl.bind(mainMod .. " + SHIFT + CTRL + DOWN", hl.dsp.window.resize({ x = 0, y = 30, relative = true }), { repeat_press = true, description = "resize down" })

-- Move focused window to a relative workspace
hl.bind(mainMod .. " + CTRL + ALT + RIGHT", hl.dsp.window.move({ workspace = "r+1" }), { description = "move workspace r+1" })
hl.bind(mainMod .. " + CTRL + ALT + LEFT", hl.dsp.window.move({ workspace = "r-1" }), { description = "move workspace r-1" })
...
hl.bind(mainMod .. " + ALT + S", hl.dsp.window.move({ workspace = "special:scratchpad", follow = false }), { description = "move special" })
